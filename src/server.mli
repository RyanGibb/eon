...
val udp_listen :
  Dns_log.formattedLog -> handle_dns -> #Eio.Net.datagram_socket -> unit
...
val tcp_handle : Dns_log.formattedLog -> handle_dns -> connection_handler
(* handles a single TCP connection using the handle_dns callback to process queries *)

val tcp_listen : #Eio.Net.listening_socket -> connection_handler -> unit
